...
namespace PictureGallery.ViewModels
{
    ...
    public class PhotoViewModel : ImageServiceViewModel
    {
        ...
        public AuthorViewModel Author
        {
            get
            {
                if (this.author == null && !this.downloadingAuthor)
                {
                    ...
                    App.Instance.CurrentImageServiceProvider.GetAuthorOfPhoto(this.PhotoId, OnAuthorDownloaded);
                }
        ...
        public IEnumerable<CommentViewModel> Comments
        {
            get
            {
                if (this.comments == null && !this.downloadingComments)
                {
                    ...
                    App.Instance.CurrentImageServiceProvider.GetComments(this.PhotoId, OnCommentsDownloaded);
                }
        ...
        [DataMember]
        public Collection<string> Sizes
        {
            get;
            set;
        }
        ...
        {
            PhotoViewModel model = obj as PhotoViewModel;
            if (model != null)
            {
